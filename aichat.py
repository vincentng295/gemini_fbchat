                            ...
                            try:
                                ...
                                def process_elements(msg_table):
                                    ...
                                    for msg_element in reversed(msg_table.find_elements(By.CSS_SELECTOR, 'div[role="row"]')):
                                        ...
                                        # Finding name
                                        indicator = msg_element.find_elements(By.CSS_SELECTOR, 'div.x1xc55vz[role="none"]')
                                        if len(indicator) > 0:
                                            break
                                        # Scrape user name
                                        name = None
                                ...
                                def reset_chat(chatid = None, title = None):
                                    ...
                                    return f'Bot has been reset in chat with id {chatid}'
                                ...
                                def set_litemode(mode, _1 = None):
                                    ...
                                    if mode.lower() == "true" or mode == "1":
                                        ...
                                        return f'Enabled litemode!'
                                    if mode.lower() == "false" or mode == "0":
                                        chat_infos[admin_fbid]["admin_settings"]["aichat_lite"] = False
                                        return f'Disable litemode!'
                                    return f'Unknown lite mode! Use "1" to enable or "0" to disable.'
                                ...
                                def set_autofriends(mode, _1 = None):
                                    ...
                                    if mode.lower() == "true" or mode == "1":
                                        ...
                                        return f'Enabled auto adding friends!'
                                    if mode.lower() == "false" or mode == "0":
                                        chat_infos[admin_fbid]["admin_settings"]["auto_friends"] = False
                                        return f'Disabled auto adding friends!'
                                    return f'Unknown auto adding friends mode! Use "1" to enable or "0" to disable.'
                                ...
                                for _x in range(10):
                                    try:
                                        ...
                                        if caption is not None:
                                            ...
                                            send_keys_long_text(driver, get_message_input(), reply_msg)
                                            ...
                                            if "bye" in bot_commands:
                                                ...
                                                for bye_msg in bye_msg_list:
                                                    if bye_msg:
                                                        send_keys_long_text(driver, get_message_input(), bye_msg)
                                                        get_message_input().send_keys("\n")
                                            try: # save the screenshot
                                                os.makedirs("screenshot", exist_ok=True)
                                                main.screenshot(f"screenshot/{message_id}.png")
